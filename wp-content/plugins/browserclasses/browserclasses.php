...
/*
Plugin Name: Browserclasses
Description: Add Browserclasses to the body
Version: 1.0
...
add_filter( 'body_class', 'bc_add_classes' );
  function bc_add_classes( $classes ) {
  ...
  $classes[] = $os . ' ' . $browser . ' ' . $engine;

  if ($version != '') {
    $classes[] = $shorty . $version;
  }
