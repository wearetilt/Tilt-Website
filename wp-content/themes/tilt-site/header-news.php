...
<body <?php body_class(); ?>>
	<nav>
		<svg style="display: none;">
			...
			<symbol viewBox="0 0 75 75" id="mail" >
				<path fill="#FFF" d="M61.5 54h-48V23.6l22.1 17.7C36.2 41.8 36.8 42 37.5 42s1.3-0.2 1.9-0.7l22.1-17.7V54zM55.2 21L37.5 35.2 19.8 21H55.2zM67.5 18.8l0 0C67.3 16.7 65.4 15 63.3 15h-51.5c-2.2 0-4 1.7-4.2 3.8L7.5 18.8l0 0c0 0.1 0 0.3 0 0.4v36.5c0 2.3 1.9 4.3 4.3 4.3h51.5c2.3 0 4.3-1.9 4.3-4.2v-36.5c0-0.1 0-0.3 0-0.4L67.5 18.8z"/>
			</symbol>
