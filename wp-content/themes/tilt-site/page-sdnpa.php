...
<header id="page_sdnpa" class="work-item work-item--motion area-dark">
    <div class="module--video module--header">
        ...
        <div class="ratio">
            <video id="header-video-player" class="video-js vjs-default-skin" autoplay loop muted poster="<?php echo get_template_directory_uri(); ?>/images/work/film_sd/sd_poster.jpg" width="100%" height="100%">
