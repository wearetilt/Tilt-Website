...
<div id="video-overlay" class="fullpage-overlay">
    <video id="overlay-video" controls class="video-js vjs-default-skin vertical-align" poster="<?php echo get_template_directory_uri(); ?>/images/work/film_sd/sd_poster.jpg" width="100%" height="auto">
...
<header id="page_sdnpa" class="work-item work-item--motion area-dark">
    <div class="module--video module--header">
        <div id="header-play" class="header-play">

        </div>
        <div class="ratio">
            <video id="header-video-player" class="video-js vjs-default-skin" autoplay loop poster="<?php echo get_template_directory_uri(); ?>/images/work/film_sd/sd_poster.jpg" width="100%" height="100%" controls >
    ...
    <div class="container container--header container--header-desktop">
        ...
        <div class="header-text">
            <div class="header-text__module header-text__module--padding">
                <h2>The Brief</h2>
                <p class="first-para tag--work-title">How can you encourage people to take public transport to the beautiful South Downs National Park, and even make them excited to do so?</p>
            </div>
            <div class="header-text__module header-text__module--padding">
                <h2>The Big Idea</h2>
                <p class="first-para tag--work-title">Merge film and motion graphics to create a magical experience that brings an entire journey to the South Downs to life through the eyes of a child.</p>
            </div>
        </div>
    </div>
</header>
...
<div class="group-container">
    <a class="project-navigation paginate_prev" href="../bp-fll-stories">Previous Project</a>
