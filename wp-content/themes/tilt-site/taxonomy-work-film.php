    ...
    <section id="primary" class="content-area">
        ...
        <?php if (have_posts()) : ?>
            ...
            <div class="film-show-reel area-dark">
                ...
                <div class="reel-title"> <h2>Film Reel</h2></div>
                <video class="video-js vjs-default-skin" width="100%" height="100%" >
                  <source id="header-video"  src="https://player.vimeo.com/external/312876149.hd.mp4?s=2d7ff001440883e45b43d8c7d8025e07e94a6457&profile_id=174" type="video/mp4">
                  </video>
            </div>
