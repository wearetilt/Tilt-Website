...
<div id="video-overlay" class="fullpage-overlay">
    <video id="overlay-video" controls class="video-js vjs-default-skin vertical-align" poster="<?php echo get_template_directory_uri(); ?>/images/work/film_ril/ril_poster.jpg" width="100%" height="auto">
...
<header id="page_reliace" class="work-item work-item--motion area-dark">
...
<div class="group-container">
    <a class="project-navigation paginate_prev" href="../sdnpa">Previous Project</a>
    <a class="project-navigation paginate_next" href="../barclays-values">Next Project</a>
</div>
