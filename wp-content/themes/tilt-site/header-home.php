...
<svg style="display: none;">
	...
	<symbol id="twitter" viewbox="-256.8 370.7 52.1 51.6">
	...
	<symbol id="vimeo" viewbox="0 0 72 63">
		<path fill-rule="evenodd" clip-rule="evenodd" fill="#666" d="M3.36 21.36l-3.35-4.4 10.45-9.4c4.77-4.13 8.32-6.28 10.65-6.45 5.6-.5 9.03 3.33 10.3 11.5 1.47 9.03 2.45 14.55 2.95 16.55 1.6 7.33 3.37 11 5.3 11 1.53 0 3.78-2.38 6.75-7.15 3.07-4.73 4.68-8.35 4.85-10.85.43-4.1-1.18-6.15-4.85-6.15-1.73 0-3.5.38-5.3 1.15C44.64 5.59 51.41-.02 61.41.31c7.43.2 10.95 5 10.55 14.4-.37 7.03-5.27 16.65-14.7 28.85-9.8 12.77-18.08 19.15-24.85 19.15-4.17 0-7.72-3.9-10.65-11.7l-5.8-21.4c-2.17-7.77-4.48-11.65-6.95-11.65-.5 0-2.38 1.13-5.65 3.4z"/>
	</symbol>
	<symbol id="instagram" viewbox="0 0 17 17">
		<path fill="#494949" d="M29 20.1c0 6.7-5.5 12.2-12.2 12.2-6.7 0-12.2-5.5-12.2-12.2 0-6.7 5.5-12.2 12.2-12.2 6.8 0 12.2 5.4 12.2 12.2m28.2 0c0 6.7-5.5 12.2-12.2 12.2-6.7 0-12.2-5.5-12.2-12.2 0-6.7 5.5-12.2 12.2-12.2 6.7 0 12.2 5.4 12.2 12.2m15.1 20.7v22.1l-13.7-5.3V46.7"/>
		<path fill="#494949" d="M52.1 44c-1.4 0-2.6-1.1-2.6-2.6 0-1.4 1.1-2.6 2.6-2.6s2.6 1.1 2.6 2.6c-.1 1.5-1.2 2.6-2.6 2.6zm-7.2 17.4H17.7v-19h27.2v19zm9.8-26.7H7.9c-2.6 0-4.6 2.1-4.6 4.6v25.1C3.3 67 5.4 69 7.9 69h46.7c2.6 0 4.6-2.1 4.6-4.6V39.3c.1-2.5-2-4.6-4.5-4.6z"/>
	</symbol>
	<symbol id="youtube" viewbox="-194.6 333.8 94.8 125.5">
	...
	<symbol id="tilt" viewbox="0 0 38 31">
...
<body <?php body_class(); ?>>
	<nav>
		...
		<a id="menuButton" class="header-item header-item--menu">
			 <svg xmlns="http://www.w3.org/2000/svg" viewBox="-284 411.9 27 19">
				 <rect class="rect-1" fill="#FFFFFF" width="27" height="3"/>
				 <rect class="rect-2" y="8" fill="#FFFFFF" width="27" height="3"/>
				 <rect class="rect-3" y="16" fill="#FFFFFF" width="27" height="3"/>
			 </svg>
	 	</a>
       <a id="closeButton" class="header-item header-item--menu">Close</a>
        ...
        <div id="pageMenu" class="menu">
            ...
            <div class="nav-icons">
				...
				<div id="nav-icon-5" class="nav-icon"><a href="https://www.youtube.com/channel/UC0JTRabxxDhTzUUBd9CatiQ" target="_blank" ></a></div>
				<div id="nav-icon-6" class="nav-icon"><a href="http://bakery.wearetilt.com/" target="_blank" ></a></div>
				<div class="telephone">
