...
function my_password_form()
{
	...
	$o = '<div class="container area-dark contact--page pw-protect-login-form">
            ...
            <section class="text-section">
              ...
              <p>So, you’re curious about this case study? Good choice. But as Gandalf once said, "You shall not pass"—unless, of course, you have the password.</p>
							<p>If you do, step right in—but remember, “with great power comes great responsibility.”</p>
							<p>If not, and intrigue has got the better of you, reach out to Emma at <a style="font-size: inherit; text-transform: none;" href
							"mailto:emma.depolnay@wearetilt.com">emma.depolnay@wearetilt.com</a>. She’s the keeper of the keys.</p>
...
function rewrite_cube_button($block_content, $block)
{
	...
	if ('core/button' === $block['blockName']  && $block['attrs']['className'] == 'is-style-cube') {
		...
		$block_content = '<a class="cube--link" href="' . $url . '"><div class="cube"><div class="cube--front cube--front__no-bg"><p class="">Send us your details</p></div><div class="cube--top cube--top__no-bg"><p class="">Send us your details</p></div></div></a>';
	}
