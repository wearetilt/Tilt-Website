...
<h2>GDPR Privacy Notice for Job Applicants, Employees, Workers, Volunteers and Contractors (UK)</h2>

<h4>What is the purpose of this document?</h4>
<p>WE ARE TILT LIMITED is committed to protecting the privacy and security of your personal information.</p>
...
<p>WE ARE TILT LIMITED is a "data controller". This means that we are responsible for deciding how we hold and use personal information about you. We are required under data protection legislation to notify you of the information contained in this privacy notice.</p>
...
<h4>How is your personal information collected?</h4>
  <p>We typically collect personal information about employees, workers and contractors through the application and recruitment process, either directly from candidates or sometimes from an employment agency or background check provider. We may sometimes collect additional information from third parties including former employers, credit reference agencies or other background check agencies.<p>
...
<h4>Situations in which we will use your personal information</h4>
...
<ul>
  ...
  <li>Providing any benefits to you with your prior knowledge and consent.</li>
...
<p>We may also process such information about members or former members in the course of legitimate business activities with the appropriate safeguards.</p>
...
<h4>Why might you share my personal information with third parties?</h4>
...
<p>"Third parties" includes third-party service providers (including contractors and designated agents) and other entities within our group. The following activities are carried out by third-party service providers: payroll, pension administration, benefits provision and administration, IT services. The following third-party service providers process personal information about you for the following purposes: Chase Templeton Private Health Insurance broker and insurance provider AXA PPP.</p>
  ...
  <h4>When might you share my personal information with other entities in the group?</h4>
  ...
  <h4>Transferring information outside the EU</h4>
    <p>We may transfer the personal information we collect about you to countries outside the EU in order to perform our contract with you.</p>
    <p>However, to ensure that your personal information does receive an adequate level of protection we have put in place the following appropriate measure[s] to ensure that your personal information is treated by those third parties in a way that is consistent with and which respects the EU and UK laws on data protection: BINDING CORPORATE RULES. If you require further information about this protective measure, you can request it from DPO Jonathan Malyon.</p>

  <h4>Data security</h4>
    <p>We have put in place measures to protect the security of your information. Details of these measures are available upon request or on the server.</p>
    ...
    <p>We have put in place appropriate security measures to prevent your personal information from being accidentally lost, used or accessed in an unauthorised way, altered or disclosed. In addition, we limit access to your personal information to those employees, agents, contractors and other third parties who have a business need to know. They will only process your personal information on our instructions and they are subject to a duty of confidentiality. Details of these measures may be obtained from Jonathan Malyon, Managing Director.</p>
  ...
  <h4>Data retention</h4>
    <h4>How long will you use my information for?</h4>
      <p>We will only retain your personal information for as long as necessary to fulfil the purposes we collected it for, including for the purposes of satisfying any legal, accounting, or reporting requirements. Details of retention periods for different aspects of your personal information are available in our retention policy which is available from Jonathan Malyon, Managing Director, or the server. To determine the appropriate retention period for personal data, we consider the amount, nature, and sensitivity of the personal data, the potential risk of harm from unauthorised use or disclosure of your personal data, the purposes for which we process your personal data and whether we can achieve those purposes through other means, and the applicable legal requirements. </p>

      <p>In some circumstances we may anonymise your personal information so that it can no longer be associated with you, in which case we may use such information without further notice to you. Once you are no longer an employee, worker or contractor of the company we will retain and securely destroy your personal information in accordance with our data retention policy OR applicable laws and regulations.</p>
  ...
  <h4>Your rights in connection with personal information</h4>
    <ul>Under certain circumstances, by law you have the right to:
      ...
      <li>Request the transfer of your personal information to another party. 
      If you want to review, verify, correct or request erasure of your personal information, object to the processing of your personal data, or request that we transfer a copy of your personal information to another party, please contact Jonathan Malyon in writing.</li>
    </ul>
  ...
  <h4>Right to withdraw consent</h4>
    <p>In the limited circumstances where you may have provided your consent to the collection, processing and transfer of your personal information for a specific purpose, you have the right to withdraw your consent for that specific processing at any time. To withdraw your consent, please contact Jonathan Malyon. Once we have received notification that you have withdrawn your consent, we will no longer process your information for the purpose or purposes you originally agreed to, unless we have another legitimate basis for doing so in law.</p>
