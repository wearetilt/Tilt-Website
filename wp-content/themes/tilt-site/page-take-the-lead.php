...
<div id="video-overlay" class="fullpage-overlay">
    <video id="overlay-video" controls class="video-js vjs-default-skin vertical-align" poster="<?php echo get_template_directory_uri(); ?>/images/work/mo_ttl/ttl_poster_1.jpg" width="100%" height="auto">
...
<header id="page_take_the_lead" class="work-item work-item--motion area-dark">
    <div class="module--video module--header">
        ...
        <div class="ratio">
            <video id="header-video-player" class="video-js vjs-default-skin" autoplay loop muted width="100%" height="100%" poster="<?php echo get_template_directory_uri(); ?>/images/work/mo_ttl/ttl_poster_2.jpg">
...
<div class="group-container">
    <a class="project-navigation paginate_prev" href="../barclays-integrity"><span>&#8249;</span> Previous Project</a>
    <a class="project-navigation paginate_next" href="../legacy">Next Project <span>&#8250;</span></a>
</div>
